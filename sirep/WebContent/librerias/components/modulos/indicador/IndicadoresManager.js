Ext.ns('IndicadoresManager');
IndicadoresManager={
		
		openAdminIndicador:function(option){
		var indicador=option.indicador;
		console.log(indicador);
		var config={

                title: 'Crear Nuevo Indicadores',
                width: 800,
                id:'winIndicadorNewSave',
                modal:true,
                height: 340,
                resizable:false,
                layout: 'fit',
