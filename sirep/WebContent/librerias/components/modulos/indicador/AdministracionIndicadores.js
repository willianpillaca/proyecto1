Ext.define('indicadores.AdministracionObjetivos', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.indicadorAdmin',
	...
	createFormUser:function(){
		...
		Ext.create('Ext.form.Panel',{
					...
					,items:[
					        ...
					        {
					        	xtype:'textfield'
					        	,fieldLabel: 'Indicador Numerador'
					        	,allowBlank:false					        	
					        }
							,
					        {
					        	xtype:'textfield'
					        	,fieldLabel: 'Indicador Denominador'
					        	,allowBlank:false					        	
					        }
					        ]
					    ...
					    items:[{
					        ...
					        html: '<div class="panel panel-default" style="height:248px;">'+
						            '<div class="panel-heading" style="padding:7px !important;">'+
									    '<h3 class="panel-title" style="font-size:12px;" >Datos del Indicador</h3>'+
									  '</div>'+
