				...
				<div class="container">
					...
					<div class="navbar-collapse collapse ">
						<ul class="nav navbar-nav">
							...
							<li><a href="#" role="button" data-toggle="modal" data-target="#login-modal">Iniciar Sesión</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="container">
					...
					<div class="col-lg-12">
						<div class="row">
							<div class="card col-lg-3">
								<div class="card-body box">
									<div class="box-gray aligncenter">
										<h5 class="card-title">Microsoft Word 2015</h5>
										<div class="icon">
											<img src="librerias/imagenes/icon_word_64.png">
										</div>
										<p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										<h4>Microsoft Excel 2015</h4>
										<div class="icon">
											<img src="librerias/imagenes/icon_excel_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										<h4>Linux Server</h4>
										<div class="icon">
											<img src="librerias/imagenes/icon_linux_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										...
										<div class="icon">
											<img src="librerias/imagenes/icon_windows_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
				...
				<div class="row">
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										<h4>Microsoft Acces</h4>
										<div class="icon">
											<img src="librerias/imagenes/icon_acces_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										<h4>SQL server 2015</h4>
										<div class="icon">
											<img src="librerias/imagenes/icon_sql_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										<h4>Microsoft office 2013</h4>
										<div class="icon">
											<img src="librerias/imagenes/icon_office_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter">
										...
										<div class="icon">
											<img src="librerias/imagenes/icon_java_64.png">
										</div>
										<p>
											Voluptatem accusantium doloremque laudantium sprea totam rem aperiam.
										</p>
                ...
                <div id="div_forms_pago">                
                    ...
                    <form id="form_pago">
		                <div class="modal-body">
				    		...
				    		<input id="pago_dni" class="form-control" type="text" value="120 soles" required>
				    		
                            
        		    	</div>
				        <div class="modal-footer">
                            <div>
                                <button type="submit" class="btn btn-theme btn-lg btn-block">Pagar</button>
                            </div>				    	    
				        </div>
                    </form>
                    <!-- End # Login Form -->                    
