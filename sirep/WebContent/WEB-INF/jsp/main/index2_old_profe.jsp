...
<body>
	<div id="wrapper">
		...
		<section id="content">
								...
								<table id="mytable" class="table table-bordred table-striped">
									...
									<tbody>
										<tr>
											...
											<td>Evaluado</td>
											<td>descargar</td>											
											<td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-theme" data-title="Edit" data-toggle="modal" data-target="#addPregunta" ><span class="fa fa-edit"></span></button></p></td>
											<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-success" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fa fa-address-card-o"></span></button></p></td>
										</tr>
										<tr>
											<td><input type="checkbox" class="checkthis" /></td>
											...
											<td>descargar</td>											
											<td><p data-placement="top" data-toggle="tooltip" title="Rendir Examen"><button class="btn btn-theme" data-title="Edit" data-toggle="modal" data-target="#addPregunta" ><span class="fa fa-edit"></span></button></p></td>
											<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-success" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fa fa-address-card-o"></span></button></p></td>
										</tr>
										<tr>
											<td><input type="checkbox" class="checkthis" /></td>
											<td>Mircrosoft Office 2013</td>	
										...
										<tr>
											<td><input type="checkbox" class="checkthis" /></td>
											<td>Mircrosoft Power Point 2013</td>
											<td>Cordova Aquino ricardo</td>
											<td>Pediente por Evaluar</td>
											<td>descargar</td>											
											<td><p data-placement="top" data-toggle="tooltip" title="Agregar Pregunta"><button class="btn btn-theme" data-title="Edit" data-toggle="modal" data-target="#addPregunta" ><span class="fa fa-edit"></span></button></p></td>
											<td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-success" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fa fa-address-card-o"></span></button></p></td>
										</tr>										
									</tbody>
			...
			<div class="modal fade" id="addPregunta" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
