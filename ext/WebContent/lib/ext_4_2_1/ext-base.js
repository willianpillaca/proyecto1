...
(function() {
//    var A = Ext.lib.Ajax,defined = function(test){return typeof test != 'undefined';},
//        emptyFn = Ext.emptyFn || function(){},
//        OP = Object.prototype;
        
	  var defined = function(test){return typeof test != 'undefined';},
        emptyFn = Ext.emptyFn || function(){},
        OP = Object.prototype;
...
//    });
    ...
    Ext.apply({}, {
	    ...
	    monitoredNode : function(tag, attributes, callback, context, deferred) {
	        ...
	        if (tag && doc && head) {
	            node = tag.toUpperCase() == 'SCRIPT'  ? null : null;
	            if(node){
